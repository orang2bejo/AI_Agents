...
Adapter for Qwen API (Alibaba Cloud's AI models).
"""
...
class QwenProvider(LLMProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, base_url: str = "https://dashscope.aliyuncs.com/compatible-mode/v1", **kwargs):
    ...
    def capabilities(self) -> ModelCapabilities:
        # Return default capabilities for Qwen2.5-72B
        return MODEL_CATALOG.get("qwen2.5-72b-instruct", ModelCapabilities(
            max_context=131072,
            supports_tools=True,
    ...
    def count_tokens(self, messages: List[LLMMessage]) -> int:
        ...
        # Rough estimate: 3.5 characters per token (better for Chinese/multilingual)
    ...
    def estimate_cost(self, messages: List[LLMMessage], model: str = "qwen2.5-72b-instruct") -> float:
